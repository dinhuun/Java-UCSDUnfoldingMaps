...
public class LifeExpectancy extends PApplet {
	...
	public void setup() {
		...
		// this list of features countries will have markers
		countries = GeoJSONReader.loadData(this, "countries.geo.json");
		// create markers for countries, while other lists of features may not have markers
		countryMarkers = MapUtils.createSimpleMarkers(countries);
		// add markers for countries to map
	...
	//Helper method to load life expectancy data from file
		private HashMap<String, Float> loadLifeExpectancyFromCSV(String fileName) {
			...
			for (String row : rows) {
				...
				// columns[5] is a string and has to be parsed into float
